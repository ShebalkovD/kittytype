    ...
    return(
        ...
        >
            <div className="container flex flex-col items-center justify-start min-h-[calc(100vh-6rem)]">
                ...
                <div 
                    className="restart hover:cursor-pointer text-center flex flex-col justify-center items-center hover:[&>svg]:opacity-100 hover:[&>p]:opacity-0 hover:[&>p]:translate-y-1"
                    onClick={restart}
                >
